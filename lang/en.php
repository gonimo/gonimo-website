...
$k = [ "Thank you very much for your message. We will take care of it as soon as possible."
	 ...
	 , "General"
	 , "Family is a safe space, that's why SECURITY is a major issue at gonimo. Here you can learn about the technical safety measures that gonimo uses."
	 , "Peer-to-Peer (P2P)"
	 ...
	 , "Your devices are managed in your 'gonimo-family'. If you use gonimo for the first time a family is created for you. With our invitation system you can add new devices to your family. Every invitation contains a complex code and is only valid a single time. This ensures that you only got the people in your family that belong there.<br>If you accidentally invite the wrong person you can simply click on the invitation-link yourself and render it invalid. If its already too late you can easily remove unloved and wrong members from your family in the family-management.<br>If everything goes wrong, you can just create a new family and start over."
	 , "PIWIK"
