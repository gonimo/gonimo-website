...
$i_s = ["Send an invitation from one device to another."
       ...
       , "Press 'Start babystation' on one of the devices"
       , "Start babystation"
       , "When the request has been accepted on the added device, you pick one of the devices to be the baby station. You do this by selecting 'baby station' in the menu."
       , "Click 'CONNECT TO BABY' on the other device."
       , "Connect to baby"
...
$i_b = [ "Gonimo's advantages"
       ...
       , "Gonimo is an open source project and available to everyone for free, without any ads or restrictions!"
       , "Gonimo in a backpack"
       , "ALWAYS BY YOUR SIDE"
       , "Gonimo is the first platform-independent, browser-based baby monitor that works on virtually any device."
...
$k = [ "Thank you very much for your message. We will deal with it as soon as possible."
     , "Thank you for your request. We will be in touch as soon as possible."
     , "Get in touch"
     , "Press inquiries"
     , "Please send us your press inquiry via the form below."
     , "Ask us a question, <br>share your thoughts, <br>give us feedback, <br><br>send us a message ! <br><br>Please use this form:<br>"
     , "Name"
     , "E-mail"
     , "Your e-mail address"
     , "Subject"
