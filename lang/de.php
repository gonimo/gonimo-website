...
$banner = "<div class='impact banner highlight'>Gonimo verabschiedet <a class='link' href='https://github.com/gonimo/gonimo/wiki/End-of-Life'>sich</a>!</div>";
...
$i_i = [ "Das kostenlose Babyfon für Smartphone, Tablet oder PC."
   ...
   'Babyfon Starten' kannst du sofort loslegen, ohne Download und ohne Installation.<br>"
         , "<li>Kostenlose Webversion</li> <li>Auf jedem Gerät verfügbar</li>
 </li><li>Ohne Installation</li><li>Stabil, einfach und <a class='link' href='/security.php' title='Sicherheit'>sicher</a></li><li>Direkt hier im Browser <span class='browser-icons'><i class='fa fa-chrome' title='Chrome' aria-hidden='true'></i>&nbsp;<i class='fa fa-firefox' title='Firefox' aria-hidden='true'></i></span></li>"
...
$i_t = [ "Gonimo-Team-Foto"
       , "Team"
       , "ÜBER UNS"
       ];

$i_h = [ "Wie kannst du uns helfen ?"
       , "Ein Sparschwein"
       , "Spenden"
       , "Mit deiner Spende unterstützt du unser Open Source Projekt, um dieses weiter entwickeln und verbessern zu können.<br><br>Vielen Dank für deine Unterstützung!"
...
$t = [ "Team"
     ...
     , "Programmierung"
     , "Weil's vom Boss doch nicht immer passt"
     , "Grafikdesign"
...
$apps = [
    ...
    , "Alle aktuellen und zukünftigen Versionen von Gonimo sind untereinander kompatibel. Das bedeutet egal auf welchen Geräten und mit welchen Versionen du Gonimo verwendest du kannst immer mit deiner Gonimo-Familie in Kontakt bleiben.<br>Durch die unterschiedlichen Technologien können wir leider nicht alle Funktionen in jeder Version anbieten. Gonimo wird aber keine Version absichtlich verschlechtern um dich zum Kauf zu drängen. Wir wollen in jeder Ausführung das Bestmögliche für dich und deine Familie herausholen und arbeiten auch ständig an der Verbesserung aller bestehenden und der Entwicklung neuer Versionen.<br>Gonimo ist und bleibt auch weiterhin komplett Open-Source, das bedeutet du kannst den dahinterliegenden Code all unserer Versionen einsehen und unter den Bedingungen der GNU_Affero_General_Public_License verwenden."
    , "Webapp"
    , "Das Original in deinem Webbrowser"
    , "Als Webapp steht gonimo dir flexibel, von den verschiedensten Geräten aus, zur Verfügung. Egal ob Workstation im Büro, Gaming-PC zuhause, Notebook oder Smartphone unterwegs. Die Gonimo Webapp ist jederzeit und kostenlos für dich da. Auf Windows, OSX oder Linux, die einzige Voraussetzung ist ein moderner Browser und für die Babystation natürlich ein Mikrofon oder eine Kamera."
    , "Webapp direkt starten"
    , "Mehr Informationen zur Webapp"
    , "Gonimo Android App"
    , "Erweiterte Funktionen für dein Smartphone"
    , "Als native App kann Gonimo erweiterte Funktionen und eine bessere Performance bieten als in deinem Browser. Auf bestimmte Funktionen dürfen Webbrowser nicht zugreifen und das ist aus Sicherheitsgründen auch gut so. Leider sind so die Funktionen der Webapp beschränkt. Als native App für Android kann Gonimo mehr Gerätefunktionen nutzen und so zusätzliche Features anbieten. Um deine Sicherheit musst du dir trotzdem keine Sorgen machen, es gelten selbstverständlich die gleichen Grundsätze für Sicherheit und Privatsphäre wie bei allen anderen Gonimo Produkten."
    , "Gonimo bei Google Play"
    , "Mehr zur nativen App"
    , "Gonimo für iOS"
    , "iPhone und Gonimo"
    , "Leider müssen wir dich enttäuschen. Eine native App für iOS haben wir leider noch nicht. Sie ist aber definitiv geplant damit auch Apfel-Eltern und Babys in den Genuss aller Gonimo Features kommen können. Versprochen!<br> Bis dahin kannst du aber gerne die Webapp nutzen, die nun auch auf Safari läuft."
    , "Zur Webapp"
    , "Andere Systeme"
    , "Noch immer nicht zufrieden?"
    , "Wir arbeiten ständig daran Gonimo zu Verbessern und die Verfügbarkeit auf mehrere Plattformen auszuweiten. Wenn es mit deinem Lieblingsgerät zu Fehlern kommt oder Gonimo gar nicht läuft dann lass es uns bitte wissen, damit wir dafür eine Lösung finden können.<br>Wenn du andere Wünsche, Anregungen, Beschwerden oder einfach nur ein bisschen Lob für uns hast freuen wir uns natürlich auch sehr wenn du mit uns in Kontakt trittst."
    , "Gonimo kontaktieren"
    , "Feature - Übersicht"
    , "Die einzelnen Versionen im Vergleich"
    , "Start"
    , "Feature 1"
    , "Feature 2"
    , "Feature 3"
