...
<div class="container-fluid s-i lvl-0">
	...
	<p> 
	<h4>Für diese Website verantwortliche Herausgeber</h4>
	<br>
	Robert Klotzner<br>
	<br>
	<h4>Unsere Kontaktdaten</h4>
	<span class="glyphicon glyphicon-home"></span> Adresse: <br>
	Erdbergstraße 61/10<br>
	1030 Wien<br>
	Österreich<br>
	<br>
	<span class="glyphicon glyphicon-earphone"></span> Telefon: <br>
	<a href="tel:+4367762096744" target="_blank" title="Gonimo anrufen">+43 677 620 967 44</a><br>
	<br>
	<span class="glyphicon glyphicon-envelope"></span> E-Mail: <br>
	<a href="mailto:robert@gonimo.com" target="_blank" title="Mail an robert@gonimo.com senden">robert@gonimo.com</a><br>
	<br>
	Für allgemeine Anfragen: <a href="mailto:hello@gonimo.com" target="_blank" title="Mail an hello@gonimo.com senden">robert@gonimo.com</a><br>
	...
	<h1>Haftungsausschluss / Disclaimer für Webseite</h1>
	</header>
